...
url_AdGuardHome="https://gitee.com/privacy-protection-tools/anti-ad/raw/master/anti-ad-for-dnsmasq.conf"
    ...
    echo_date -------------------easylist      version $easylist_rules_local
    echo_date -------------------fanboy        version $fanboy_rules_local
    echo_date -------------------yhosts        version $yhosts_rules_local
	echo_date -------------------AdGuardHome   version $AdGuardHome_rules_local
